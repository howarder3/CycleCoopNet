...
parser.add_argument('--dataset_name', dest='dataset_name', default='edges2handbags', help='name of the dataset') # edges2handbags
parser.add_argument('--epoch', dest='epoch', type=int, default=300, help='# of epoch')
parser.add_argument('--batch_size', dest='batch_size', type=int, default=1, help='# images in batch')
parser.add_argument('--train_size', dest='train_size', type=int, default=400, help='# images used to train') # 1e8
