...
# learning rate
tf.app.flags.DEFINE_float('colorful_learning_rate',0.01,'colorful learning rate') # 0.01 # 0.007 # 1e-6 # 0.01 # 0.001 # 1e-6 # 0.01 # 0.007
...
def main(_):
	...
	with tf.Session() as sess:
		...
		model = Coop_pix2pix(sess, 
				...
				colorful_learning_rate = FLAGS.colorful_learning_rate,
